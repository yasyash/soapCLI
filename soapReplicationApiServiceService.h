...
#include "soapH.h"
    ...
    class SOAP_CMAC ReplicationApiServiceService {
      public:
        ...
        ReplicationApiServiceService(struct soap*);
        ...
        virtual int GetStations(const std::string& login, const std::string& password, struct ns__GetStationsResponse &_param_1) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'GetSensors' implementation, should return SOAP_OK or error code
        virtual int GetSensors(const std::string& login, const std::string& password, const std::string& StationID, const std::string& From, const std::string& To, struct ns__GetSensorsResponse &_param_1) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'GetHistoricalDataBrief' implementation, should return SOAP_OK or error code
        virtual int GetHistoricalDataBrief(const std::string& login, const std::string& password, int AveragePeriod, ns__ArrayOfSensors *sSensors, const std::string& From, const std::string& To, struct ns__GetHistoricalDataBriefResponse &_param_1) SOAP_PURE_VIRTUAL;
    };
#endif
