...
This report was generated by soapcpp2 v2.8.75 for interface header file [replicator.h](replicator.h) with options -r  -S -L -i 
...
<tr><td><code><a href="#ns__StationInfo"> ns__StationInfo </a></code></td><td> replicator.h:37 </td><td> yes </td></tr>
<tr><td><code><a href="#ns__UnitInfo"> ns__UnitInfo </a></code></td><td> replicator.h:49 </td><td> yes </td></tr>
<tr><td><code><a href="#ns__SensorInfo"> ns__SensorInfo </a></code></td><td> replicator.h:56 </td><td> yes </td></tr>
<tr><td><code><a href="#ns__ArrayOfStationInfo"> ns__ArrayOfStationInfo </a></code></td><td> replicator.h:72 </td><td> yes </td></tr>
<tr><td><code><a href="#ns__ArrayOfSensorsInfo"> ns__ArrayOfSensorsInfo </a></code></td><td> replicator.h:78 </td><td> yes </td></tr>
<tr><td><code><a href="#ns__GetStationsResponse"> ns__GetStationsResponse </a></code></td><td> replicator.h:83 </td><td> yes </td></tr>
<tr><td><code><a href="#ns__GetSensorsResponse"> ns__GetSensorsResponse </a></code></td><td> replicator.h:90 </td><td> yes </td></tr>
<tr><td><code><a href="#ns__StInfo"> ns__StInfo </a></code></td><td> replicator.h:97 </td><td> yes </td></tr>
<tr><td><code><a href="#ns__GetStations"> struct ns__GetStations </a></code></td><td> replicator.h:106 </td><td> yes </td></tr>
<tr><td><code><a href="#ns__GetSensors"> struct ns__GetSensors </a></code></td><td> replicator.h:107 </td><td> yes </td></tr>
<tr><td><code><a href="#SOAP_ENV__Header"> struct SOAP_ENV__Header </a></code></td><td> replicator.h:108 </td><td> yes </td></tr>
<tr><td><code><a href="#SOAP_ENV__Code"> struct SOAP_ENV__Code </a></code></td><td> replicator.h:108 </td><td> yes </td></tr>
<tr><td><code><a href="#SOAP_ENV__Detail"> struct SOAP_ENV__Detail </a></code></td><td> replicator.h:108 </td><td> yes </td></tr>
<tr><td><code><a href="#SOAP_ENV__Reason"> struct SOAP_ENV__Reason </a></code></td><td> replicator.h:108 </td><td> yes </td></tr>
<tr><td><code><a href="#SOAP_ENV__Fault"> struct SOAP_ENV__Fault </a></code></td><td> replicator.h:108 </td><td> yes </td></tr>
</table>
...
This class is declared in [replicator.h](replicator.h) at line 37, is serialized as XML schema type *`ns:StationInfo`*, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [replicator.h](replicator.h) at line 49, is serialized as XML schema type *`ns:UnitInfo`*, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [replicator.h](replicator.h) at line 56, is serialized as XML schema type *`ns:SensorInfo`*, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [replicator.h](replicator.h) at line 72, is serialized as XML schema type *`ns:ArrayOfStationInfo`*, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [replicator.h](replicator.h) at line 78, is serialized as XML schema type *`ns:ArrayOfSensorsInfo`*, and has the following auto-completed declaration in soapStub.h:
...
- `std::vector<ns__SensorInfo> SensorsInfo` is an optional element *`<SensorsInfo>`* of XML schema type *`ns:SensorInfo`*, where the type of this member is a container of <code><a href="#ns__SensorInfo"> ns__SensorInfo </a></code>
...
This class is declared in [replicator.h](replicator.h) at line 83, is serialized as XML schema type *`ns:GetStationsResponse`*, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [replicator.h](replicator.h) at line 90, is serialized as XML schema type *`ns:GetSensorsResponse`*, and has the following auto-completed declaration in soapStub.h:
...
- `ns__GetSensorsResponse *soap_new_ns__GetSensorsResponse(struct soap*)` managed allocation with default initialization
...
This class is declared in [replicator.h](replicator.h) at line 97, is serialized as XML schema type *`ns:StInfo`*, and has the following auto-completed declaration in soapStub.h:
...
This struct is declared in [replicator.h](replicator.h) at line 106, is serialized as XML schema type *`ns:GetStations`* and is internally used as the operation request element *`<ns:GetStations>`* with the request parameters of service operation `ns__GetStations()`.
...
This struct is declared in [replicator.h](replicator.h) at line 107, is serialized as XML schema type *`ns:GetSensors`* and is internally used as the operation request element *`<ns:GetSensors>`* with the request parameters of service operation `ns__GetSensors()`.
...
This struct is declared in [replicator.h](replicator.h) at line 108, is recursive, meaning it may (in)directly reference itself through its (base or derived class) members, and is the SOAP protocol *`<SOAP-ENV:Code>`* element.  This struct is for internal use and will be auto-generated when not explicitly declared.
...
This struct is declared in [replicator.h](replicator.h) at line 108, is the SOAP protocol *`<SOAP-ENV:Reason>`* element.  This struct is for internal use and will be auto-generated when not explicitly declared.
...
This struct is declared in [replicator.h](replicator.h) at line 108, is the SOAP protocol *`<SOAP-ENV:Fault>`* element with fault information and details returned by a service that triggered the error.  At the server side, a fault can be explicitly set within a service operation by calling and returning:
...
This service operation is declared in [replicator.h](replicator.h) at line 106 and has the following properties:
...
### Service Operation `ReplicationApiServiceService::GetSensors()`

This service operation is declared in [replicator.h](replicator.h) at line 107 and has the following properties:
...
- `std::wstring login` is required
- `std::wstring password` is required
- `std::wstring StationID` is required
- `std::wstring From` is required
- `std::wstring To` is required
- `ns__GetSensorsResponse &result` is the service operation response data populated by the service operation, where the type of this result parameter is <code><a href="#ns__GetSensorsResponse"> ns__GetSensorsResponse </a></code>
